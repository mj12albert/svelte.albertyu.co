...
<section class="ekpac">
  ...
  <article class="column">
    ...
    <Lede>
      <Aside services={['identity', 'web design', 'code']}>
        <span slot="year">
          2013
        </span>
      </Aside>
    ...
    <Figure>
      <video autoplay loop class="">
        <source src="/images/ekpac/ekpac-process.webm" type="video/webm; codecs=vp8">
        <source src="/images/ekpac/ekpac-process.mp4" type="video/mp4; codecs=avc1.42E01E">
        <source src="/images/ekpac/ekpac-process.ogv" type="video/ogg; codecs=theora">
      </video>
      <Caption class="project__caption--below left">The sourcing business’s process and approach was presented as candidly as possible to stand out in China’s industrial sector, which is often perceived as opaque and impenetrable.</Caption>
    </Figure>
...
<style lang="scss">
  section {
    background-color: darken(#093054, 5);
    color: rgba(#fafafa, 0.99);
  ...
  .background {
    height: 25rem;
    background-image:url('/images/ekpac/ekpac-header.jpg');
  ...
  .border {
    box-shadow: 0 0 0 1px lighten(#093054, 8);
  }
